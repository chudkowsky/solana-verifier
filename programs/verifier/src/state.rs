...
pub struct BidirectionalStackAccount {
    ...
    pub mask_values: [Felt; MASK_VALUES_SIZE],
...
impl Default for BidirectionalStackAccount {
    fn default() -> Self {
        Self {
            ...
            mask_values: [Felt::ZERO; MASK_VALUES_SIZE],
...
impl ProofData for BidirectionalStackAccount {
    ...
    fn get_mask_values(&self) -> &[Felt; MASK_VALUES_SIZE] {
        &self.mask_values
    }

    fn get_mask_values_mut(&mut self) -> &mut [Felt; MASK_VALUES_SIZE] {
    ...
    fn get_proof_data_references<T: Sized>(
        ...
        let mask_values_slice =
            unsafe { &mut *(&mut self.mask_values as *mut [Felt; MASK_VALUES_SIZE]) };
