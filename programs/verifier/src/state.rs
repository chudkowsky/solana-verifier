...
pub struct BidirectionalStackAccount {
    ...
    pub mask_values: [Felt; MASK_VALUES_ROWS_SIZE * MASK_VALUES_COLUMNS_SIZE],
...
impl Default for BidirectionalStackAccount {
    fn default() -> Self {
        Self {
            ...
            mask_values: [Felt::ZERO; MASK_VALUES_ROWS_SIZE * MASK_VALUES_COLUMNS_SIZE],
...
impl ProofData for BidirectionalStackAccount {
    ...
    fn get_mask_values(&self) -> &[Felt; MASK_VALUES_ROWS_SIZE * MASK_VALUES_COLUMNS_SIZE] {
        &self.mask_values
    }

    fn get_mask_values_mut(
        &mut self,
    ) -> &mut [Felt; MASK_VALUES_ROWS_SIZE * MASK_VALUES_COLUMNS_SIZE] {
        &mut self.mask_values
    }

    fn get_mask_column_row(&self) -> &[[Felt; MASK_VALUES_COLUMNS_SIZE]; MASK_VALUES_ROWS_SIZE] {
        // Safe cast from flat array to 2D array
        unsafe {
            &*(&self.mask_values as *const [Felt; MASK_VALUES_ROWS_SIZE * MASK_VALUES_COLUMNS_SIZE]
                as *const [[Felt; MASK_VALUES_COLUMNS_SIZE]; MASK_VALUES_ROWS_SIZE])
        }
    }

    fn get_mask_column_row_mut(
        &mut self,
    ) -> &mut [[Felt; MASK_VALUES_COLUMNS_SIZE]; MASK_VALUES_ROWS_SIZE] {
        // Safe cast from flat array to 2D array
        unsafe {
            &mut *(&mut self.mask_values
                as *mut [Felt; MASK_VALUES_ROWS_SIZE * MASK_VALUES_COLUMNS_SIZE]
                as *mut [[Felt; MASK_VALUES_COLUMNS_SIZE]; MASK_VALUES_ROWS_SIZE])
        }
    }

    fn get_domains(&self) -> &[Felt; DOMAINS_SIZE] {
        &self.domains
    }

    fn get_domains_mut(&mut self) -> &mut [Felt; DOMAINS_SIZE] {
        &mut self.domains
    }
    ...
    fn get_proof_data_references<T: Sized>(
        ...
        let mask_column_row_slice = unsafe {
            &mut *(&mut self.mask_values
                as *mut [Felt; MASK_VALUES_ROWS_SIZE * MASK_VALUES_COLUMNS_SIZE]
                as *mut [[Felt; MASK_VALUES_COLUMNS_SIZE]; MASK_VALUES_ROWS_SIZE])
        };
