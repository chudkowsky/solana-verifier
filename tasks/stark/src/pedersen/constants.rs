...
use crate::pedersen::PedersenHash;

impl PedersenHash {
    pub const CURVE_CONST_BITS: usize = 4;
    pub const TABLE_SIZE: usize = (1 << Self::CURVE_CONST_BITS) - 1;
}

pub const SHIFT_POINT: ShortWeierstrassProjectivePoint<StarkCurve> =
